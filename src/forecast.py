...
df['y'] = df['y'].clip(lower=0,upper=500)
...
forecast['yhat'] = forecast['yhat'].clip(lower=0, upper=500)
...
print("Min forecasted AQI:", forecast['yhat'].min())
print("Max forecasted AQI:", forecast['yhat'].max())